...
public class exercicioTeste4 {
    public static void main(String[] args) {
        ...
        float peso1, peso2, peso3, altura1, altura2, altura3;
        float imc1, imc2, imc3;
        String classifica1, classifica2, classifica3;
        ...
        nome3 = ler.nextLine();
        System.out.println("Peso da Pessoa 3(kg): ");
        peso3 = ler.nextFloat();
        System.out.println("Altura da pessoa 3(m): ");
        ...
        if (imc1 > imc2){
            ...
            System.out.println("A Pessoa \""+nome3+"\" tem Maior IMC");
        } if (imc2 > imc3) {
            System.out.println("A Pessoa \""+nome2+"\" tem Maior IMC");
        } else {
            System.out.println("A Pessoa \""+nome3+"\" tem Maior IMC");
