...
public class AlunoUFSC extends Pessoa{
    //Construtor VAZIO -> permite a criacao (instanciacao) de um objeto
    //vazio
    //Construtor CHEIO -> permite a instanciacao de objetos com entrada de valores
    //ao mesmo tempo de criacao
